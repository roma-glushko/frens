  ...
  <div class="flex items-center justify-between mb-8">
    <div>
      ...
      <p class="text-muted-foreground mt-2">
        Manage your friends, family, and connections
      </p>
    </div>
    <Button>
    ...
    <CardContent class="py-16">
      <div class="flex flex-col items-center justify-center text-center">
        ...
        <p class="text-sm text-muted-foreground max-w-sm mb-4">
          Start building your network by adding your first friend. You can add their contact info, important dates, and more.
        </p>
        <Button>
          <Plus class="h-4 w-4 mr-2" />
